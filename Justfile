...
generate-pdf:
    ...
    # xelatex debug
    (xelatex -interaction=batchmode -halt-on-error -file-line-error debug || xelatex -interaction=batchmode debug || (biber debug && xelatex -interaction=batchmode debug)) && cp debug.pdf {{FINAL_PDF}}
